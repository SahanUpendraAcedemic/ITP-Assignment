...
export default function CreateListing1() {
  return (
    <div className="mx-auto mt-12 w-2/4 px-4 me-64">
      ...
      <form className="flex flex-col">
        {/* <div className="flex items-center mb-6">
          <label htmlFor="supplier" className="text-red-500 w-48">Supplier Name</label>
          <select id="supplier" name="supplier" className="w-full h-12 border border-gray-300 rounded-md px-4 text-gray-700 font-roboto text-lg bg-gray-100">
        ...
        <div className="flex items-center mb-6">
          ...
          <input min='1' max='1000' type="Number" id="itemcode" name="itemcode" className="w-full h-12 border border-gray-300 rounded-md px-4 text-gray-700 font-roboto text-lg bg-gray-100" />
        </div>
        ...
        <div className="flex items-center mb-6">
          <label htmlFor="itemquentity" className="text-red-500 w-48">Item Quentity</label>
          <input  type="text" id="itemquentity" name="itemquentity" className="w-full h-12 border border-gray-300 rounded-md px-4 text-gray-700 font-roboto text-lg bg-gray-100" />
        </div>
        ...
        <div className="flex justify-between ml-64 mt-4">
          ...
          <button className="w-48 h-12 rounded-md bg-green-600 text-white font-roboto font-semibold text-lg cursor-pointer hover:bg-green-700 focus:outline-none">Save</button>
        </div>
      </form>
