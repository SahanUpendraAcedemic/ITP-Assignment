...
export default function UpdateLowInventory() {
  ...
  useEffect(() => {
    const fetchLowInventory = async () => {
      const lowinventoryId = params.lowinventoryId;
      const res = await fetch(`/api/lowinventory/get/${lowinventoryId}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setLoading(true);
      setError(false);
      const res = await fetch(`/api/lowinventory/update/${params.listingId}`, {
        method: 'POST',
        headers: {
