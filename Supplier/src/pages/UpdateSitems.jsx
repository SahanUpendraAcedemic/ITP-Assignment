    ...
    return (
        <div className="container mx-auto p-36 ml-64">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button type="submit" className="w-full bg-blue-500 text-white py-2 rounded-md hover:bg-blue-600 transition duration-300">{loading ? 'Updateing....' : 'Update items'}</button>
